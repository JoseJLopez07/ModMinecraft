...
import net.mcreator.virgencraft.procedures.OpenMenuOnKeyPressedProcedure;
...
public class OpenMenuMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenMenuOnKeyPressedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		VirgencraftMod.addNetworkMessage(OpenMenuMessage.class, OpenMenuMessage::buffer, OpenMenuMessage::new, OpenMenuMessage::handler);
	}
}
